...
class SelfPlay:
    ...
    def make_move(self, position, muzero_player):
        self.game.set_position(position, muzero_player)
        root, mcts_info = MCTS(self.config).run(
            self.model,
            numpy.expand_dims(position, axis=0),
...
class GameHistory:
    ...
    def get_stacked_observations(
        self, index=-1, num_stacked_observations=0, action_space_size=81*81
    ):
        """
